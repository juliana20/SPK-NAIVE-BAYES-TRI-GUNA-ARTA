    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN MENU</li>
          ...
          <li class="treeview {{ Request::is('user') ? 'active':null}} {{ Request::is('nasabah') ? 'active':null}} {{ Request::is('kriteria') ? 'active':null}} {{ Request::is('sub-kriteria') ? 'active':null}}">
            <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li class="{{ Request::is('kriteria') ? 'active':null}}"><a href="{{ url('kriteria') }}"><i class="fa fa-circle-o"></i> <span> Kriteria</span></a></li>
              <li class="{{ Request::is('sub-kriteria') ? 'active':null}}"><a href="{{ url('sub-kriteria') }}"><i class="fa fa-circle-o"></i> <span> Sub Kriteria</span></a></li>
